...
interface EventWithFeatures extends Events {
...
interface EventFormProps {
  initialData: EventWithFeatures | null;
...
const EventForm: React.FC<EventFormProps> = ({
  ...
  const description = initialData
    ? "Make sure to click save changes after you update the event."
    : "Please fill the required fields to add a new event.";
  const action = initialData ? "Save Changes" : "Save Event";
  ...
  async function onSubmit(values: z.infer<typeof EventFormValidation>) {
    setIsLoading(true);
    if (initialData) {
      updateEvent(params.eventId as string, values)
        .then((data) => {
          if (data.success) {
          ...
          <div className="mx-auto mt-3 grid flex-1 auto-rows-max gap-4">
            <div className="grid gap-4 md:grid-cols-[1fr_250px] lg:grid-cols-3 lg:gap-8">
              ...
              <div className="grid auto-rows-max items-start gap-4 lg:gap-8">
                ...
                >
                  <CardHeader>
                    <CardTitle>Event Inclusions</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="grid gap-6">
                      <div className="grid gap-3">
                            ...
                            <FormItem>
                              ...
                              <FormControl>
                                <DynamicSelect
                                  ...
                                  disabled={isLoading}
                                  placeholder="Select event inclusions"
